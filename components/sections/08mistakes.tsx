export default function Mistakes(){
    return (
        <section className="_section relative mt-20 flex justify-between w-full pb-[50%] sm:pb-[33.333%] md:pb-0 md:mt-40">
            ...
            <div data-aos="fade-right" data-aos-duration="2000" className="absolute z-20 w-full h-full flex justify-center max-w-[1138px]">
            ...
            <div data-aos="fade-right" data-aos-duration="2000" className="_wrapper ">
