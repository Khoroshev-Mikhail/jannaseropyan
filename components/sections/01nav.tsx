...
export default function Nav(){
    ...
    return (
        <section className="_section bg-_mainbg md:bg-_white">
            <div className="_wrapper relative flex flex-col justify-between md:flex-row md:py-1 lg:py-4">
                ...
                <div className="hidden md:flex md:justify-between md:gap-x-3 lg:gap-x-6 maxw:gap-x-7">
                ...
                {isOpen && 
                    <div onClick={()=>setIsOpen(false)} className="absolute z-30 right-0 p-3 flex flex-col w-1/2 h-auto rounded-l bg-_white">
