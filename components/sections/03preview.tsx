        ...
        <section className="_section">
            <div className="_wrapper h-full mt-20 md:flex md:justify-between">
                ...
                <div className="md:w-[50%] h-full">
                    <iframe className="w-full h-full min-h-[200px] sm:min-h-[300px] rounded-md mt-4 md:mt-0" name="janna_seropyan" src="https://www.youtube.com/embed/0k-kTeuRBv0?controls=0" title="Жанна Серопян 3.0"  />
                </div>
            </div>
        </section>
    )
